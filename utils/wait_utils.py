...
async def random_async_wait(min_ms: int = 500, max_ms: int = 1500):
...
async def human_like_click(page: Page, selector: str):
    ...
    await page.mouse.move(target_x, target_y, steps=random.randint(40, 70))
    await asyncio.sleep(random.uniform(0.1, 0.3))
    await page.mouse.click(target_x, target_y, delay=random.randint(60, 150))
